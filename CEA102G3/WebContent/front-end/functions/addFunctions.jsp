                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
						...
						<c:if test="${not empty errorMsgs}">
                            ...
                            <div class="">
                                <h3 class="h1 text-gray-900 mb-4">Guideme功能資料新增--addFunction</h3>
                            	<h4><a href="<%=request.getContextPath()%>/front-end/functions/select_functions_page.jsp">回首頁</a></h4>
                            </div>
                            
                          <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/functions/functions.do" name="form1">
                                                                            
                           <div class="">功能名稱
                           <input type="text"  id="funct_Name" name="funct_Name" 
                            value="<%=functionsVO==null ? "" : functionsVO.getFunct_Name() %>">
                           </div>
