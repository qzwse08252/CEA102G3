		...
		<jsp:include page="/back-end/experience/experSideBar.jsp" />
			<div class="container">
				...
				<form class="form-horizontal" method="POST"
					...
					<div class="form-group">
						<input type="hidden" name="host_no" value="${experVO.host_no}">
						<input type="hidden" name="exper_status"
							value="${experVO.exper_status}"> <input type="hidden"
							name="checker_no" value="${experVO.checker_no}"> <input
							type="hidden" name="exper_no" value="${experVO.exper_no}">

						<input type="hidden" name="action" value="update">


						<button class="btn btn-primary btn-block btn-lg" type="submit">送出修改</button>
					</div>
				</form>
			</div>
		</section>
