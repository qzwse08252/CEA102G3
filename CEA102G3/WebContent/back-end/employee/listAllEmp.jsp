		...
		<div class="modal-content">
			<form METHOD="post" ACTION="<%=request.getContextPath()%>/employee/employee.do" name="form1" enctype="multipart/form-data">
				...
				<div class="modal-body">				
					...
					<div class="">
						<label>員工照片</label>
                            <input type="file" id="progressbarTWInput" accept="image/gif, image/jpeg, image/png" name="emp_Pic" 
                            value="<%=employeeVO==null ? "" : employeeVO.getEmp_Pic() %>">
    						<img id="preview_progressbarTW_img"  width="160px" height="112px"/>
      						</div>
		...
		<div class="modal-content">
			<form METHOD="post" ACTION="<%=request.getContextPath()%>/employee/employee.do" style="margin-bottom: 0px;">
				...
				<div class="modal-footer">
					...
					<input type="hidden" class="btn btn-danger" name="action" value="刪除">
				</div>
			</form>
		</div>
	</div>
