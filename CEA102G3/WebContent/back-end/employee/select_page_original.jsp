...
<!--  <div style="border-width:100px; width:500px;border-style:dashed;border-color:#FFAC55;padding:5px;">  -->
<ul>
  <li><b>GuideMe</b><a href='listAllEmp.jsp'>所有員工列表</a></li>
...
<!-- <ul> -->
  <li><b>員工管理:</b><a href='addEmp.jsp'>點選進入</a></li>
</ul>
</div>
</body>
</html>