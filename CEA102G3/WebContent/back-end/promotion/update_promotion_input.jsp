...
<table>
		...
		<td>促銷商品照片:</td>
		<td>
    	<img id="preview_progressbarTW_img"  width="400px" height="280px" src="<%=request.getContextPath()%>/PicFinder?pic=1&table=promotion&column=Promot_Product_Pic&idname=Promot_No&id=<%=promotionVO.getPromot_No()%>" />
