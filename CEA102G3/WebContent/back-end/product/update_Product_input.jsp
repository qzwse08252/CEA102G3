...
<title>商品資料修改- updateProductPage</title>
<style>
table#table-1 {
	...
	<FORM METHOD="post"
		...
		<table class="table">
			...
			<tr>
				...
				<td><textarea name="descr" row="3"
						style="margin: 0px; width: 500px; height: 250px;">${(productVO==null)?'':productVO.descr}</textarea></td>

			</tr>
			<tr>
				<td>商品狀態:</td>
				<td>
					<label><input type="radio" name="productStatus" value="true" ${productVO.productStatus==true?'checked':'' }>架上</label>
					<label><input type="radio" name="productStatus" value="false" ${productVO.productStatus==false?'checked':'' }>架下</label>
				</td>
			</tr>
		...
		<div class="container" style="float: left">
			...
			<div class="input-group mb-3">
				<div class="custom-file">
					<input type="file" class="custom-file-input" id="choosePicture"
						name="productPic1"> <label class="custom-file-label"
						for="choosePicture" aria-describedby="choosePicture">選擇檔案</label>
				</div>
			...
			<div>
				...
				<div id="preview">
					<div>
						<img src="<%=request.getContextPath() %>/product/controllerImage.do?picCol=product_pic1&PKNumber=${productVO.productNo}" style="height: 200px; width: 300px;">
					</div>
				</div>
			</div>
		</div>
