            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
						...
						<h1 class="h3 mb-0 text-gray-800">歡迎進入GuideMe後台首頁</h1>
						</div>
						<div class="row">
						<h3 class="h3 mb-0 text-gray-800">請點選左側功能選單</h3>
						</div>
					<div style=""><img src="<%=request.getContextPath()%>/resources/img/world.jpg" height="700px" width="1000px"></div>
                     </div>
            <!-- End of Main Content -->
