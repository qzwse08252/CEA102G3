...
<table>
	...
	<tr>
		<td>最新消息照片:</td>
		<td>
		<img id="preview_progressbarTW_img"  width="400px" height="280px" src="<%=request.getContextPath()%>/PicFinder?pic=1&table=news&column=News_Pic&idname=News_No&id=<%=newsVO.getNews_No()%>" />
    	<input type="file" id="progressbarTWInput" name="news_Pic" accept="image/gif, image/jpeg, image/png">
	</td>
	</tr>
