...
<body>
    ...
    <div class="navbar navbar-expand navbar-light bg-white topbar fixed-top static-top shadow d-flex"
        ...
        <!-- Nav Item - logo -->
        <div class=" o-hidden">
            <img src="resources/img/logo.PNG" style="height:70px">
        </div>
        <!-- Topbar Navbar -->
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    <img class="img-profile rounded-circle w-auto h-100" src="resources/img/undraw_profile.svg">
                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-xl-12 offset-lg-1 offset-xl-0" style="font-size: 13px;">
                    ...
                    </div><img class="rounded" src="assets/img/nature-wallpaper.jpg" width="1000" style="border-width: 6px;height: 560px;margin: 0px;padding: 4px;padding-top: 2px;padding-right: 0px;width: 1100px;margin-left: 2px;">
